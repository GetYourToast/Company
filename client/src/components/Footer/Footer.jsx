    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex gap-6 text-sm text-neutral-600">
            <p className="text-sm text-neutral-500 mb-4 sm:mb-0">Made and Mainted by <a className="text-yellow-400 font-bold" href="https://www.linkedin.com/in/barathmsindia/"> Barath </a> & <a className="text-yellow-400 font-bold" href="https://www.linkedin.com/in/sagandheesh/"> Gandheesh</a></p>
